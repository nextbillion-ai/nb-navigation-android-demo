...
public class CustomInstructionListStyleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.fetchRoute) {
            ...
            NBNavigation.fetchRoute(origin, destination, new Callback<DirectionsResponse>() {
                ...
                public void onResponse(@NonNull Call<DirectionsResponse> call, @NonNull Response<DirectionsResponse> response) {
                    ...
                    if (response.body() != null && !response.body().routes().isEmpty()) {
                        ...
                        Toast.makeText(CustomInstructionListStyleActivity.this, errorMessage, Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            configBuilder.darkThemeResId(R.style.Theme_CustomNavInstructionListDark);
            NavigationLauncher.startNavigation(CustomInstructionListStyleActivity.this, configBuilder.build());
        }
    }
}